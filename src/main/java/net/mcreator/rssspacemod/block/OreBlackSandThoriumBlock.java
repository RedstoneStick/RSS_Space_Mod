...
public class OreBlackSandThoriumBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:ore_black_sand_thorium")
	public static final Block block = null;

	public OreBlackSandThoriumBlock(RssSpaceModModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("ore_black_sand_thorium");
		}
