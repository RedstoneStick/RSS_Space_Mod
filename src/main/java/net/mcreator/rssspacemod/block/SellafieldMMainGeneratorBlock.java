...
import net.mcreator.rssspacemod.procedures.SellafieldMMainGeneratorUpdateTickProcedure;
...
public class SellafieldMMainGeneratorBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:sellafield_m_main_generator")
	public static final Block block = null;

	public SellafieldMMainGeneratorBlock(RssSpaceModModElements instance) {
		super(instance, 107);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sellafield_m_main_generator");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			SellafieldMMainGeneratorUpdateTickProcedure.executeProcedure(Stream
