...
import net.mcreator.rssspacemod.procedures.CrashedSatteliteMainGeneratorUpdateTickProcedure;
...
public class CrashedSatteliteMainGeneratorBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:crashed_sattelite_main_generator")
	public static final Block block = null;

	public CrashedSatteliteMainGeneratorBlock(RssSpaceModModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crashed_sattelite_main_generator");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			CrashedSatteliteMainGeneratorUpdateTickProcedure.executeProcedure(Stream
