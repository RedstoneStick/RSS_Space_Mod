...
import net.mcreator.rssspacemod.procedures.PlacerDepositMainUpdateTickProcedure;
...
public class PlacerDepositMainBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:placer_deposit_main")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("placer_deposit_main");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			PlacerDepositMainUpdateTickProcedure.executeProcedure(Stream
