...
import net.mcreator.rssspacemod.procedures.LabLargeMainGeneratorUpdateTickProcedure;
...
public class LabLargeMainGeneratorBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:lab_large_main_generator")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lab_large_main_generator");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			LabLargeMainGeneratorUpdateTickProcedure.executeProcedure(Stream
