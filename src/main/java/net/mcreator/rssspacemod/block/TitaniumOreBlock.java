...
public class TitaniumOreBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:titanium_ore")
	public static final Block block = null;

	public TitaniumOreBlock(RssSpaceModModElements instance) {
		super(instance, 111);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("rss_space_mod:titanium_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("rss_space_mod:titanium_ore"), configuredFeature);
		}
	}
