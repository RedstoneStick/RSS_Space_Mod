...
public class FlouriteOreBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:flourite_ore")
	public static final Block block = null;

	public FlouriteOreBlock(RssSpaceModModElements instance) {
		super(instance, 112);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("rss_space_mod:flourite_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("flourite_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("rss_space_mod:flourite_ore"), configuredFeature);
		}
	}
