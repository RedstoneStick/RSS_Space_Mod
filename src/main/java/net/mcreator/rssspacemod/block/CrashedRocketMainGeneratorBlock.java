...
import net.mcreator.rssspacemod.procedures.CrashedRocketMainGeneratorOnUpdateTickProcedure;
...
public class CrashedRocketMainGeneratorBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:crashed_rocket_main_generator")
	public static final Block block = null;

	public CrashedRocketMainGeneratorBlock(RssSpaceModModElements instance) {
		super(instance, 102);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crashed_rocket_main_generator");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			CrashedRocketMainGeneratorOnUpdateTickProcedure.executeProcedure(Stream
