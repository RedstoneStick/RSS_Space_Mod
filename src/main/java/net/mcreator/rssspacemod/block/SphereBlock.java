...
public class SphereBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:sphere")
	public static final Block block = null;

	public SphereBlock(RssSpaceModModElements instance) {
		super(instance, 113);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("is it a dodecagonal sphere of a dodecahedron"));
		}
