...
import net.mcreator.rssspacemod.procedures.PowerPlantMainGeneratorUpdateTickProcedure;
...
public class PowerPlantMainGeneratorBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:power_plant_main_generator")
	public static final Block block = null;

	public PowerPlantMainGeneratorBlock(RssSpaceModModElements instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("power_plant_main_generator");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			PowerPlantMainGeneratorUpdateTickProcedure.executeProcedure(Stream
