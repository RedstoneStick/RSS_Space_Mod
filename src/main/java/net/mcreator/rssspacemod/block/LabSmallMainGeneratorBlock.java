...
import net.mcreator.rssspacemod.procedures.LabSmallMainGeneratorUpdateTickProcedure;
...
public class LabSmallMainGeneratorBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:lab_small_main_generator")
	public static final Block block = null;

	public LabSmallMainGeneratorBlock(RssSpaceModModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lab_small_main_generator");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			LabSmallMainGeneratorUpdateTickProcedure.executeProcedure(Stream
