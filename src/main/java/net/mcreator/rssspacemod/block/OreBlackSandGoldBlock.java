...
public class OreBlackSandGoldBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:ore_black_sand_gold")
	public static final Block block = null;

	public OreBlackSandGoldBlock(RssSpaceModModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("ore_black_sand_gold");
		}
