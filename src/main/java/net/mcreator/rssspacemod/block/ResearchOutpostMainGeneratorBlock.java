...
import net.mcreator.rssspacemod.procedures.ResearchOutpostMainGeneratorUpdateTickProcedure;
...
public class ResearchOutpostMainGeneratorBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:research_outpost_main_generator")
	public static final Block block = null;

	public ResearchOutpostMainGeneratorBlock(RssSpaceModModElements instance) {
		super(instance, 98);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("research_outpost_main_generator");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			ResearchOutpostMainGeneratorUpdateTickProcedure.executeProcedure(Stream
