...
public class OreBlackSandBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:ore_black_sand")
	public static final Block block = null;

	public OreBlackSandBlock(RssSpaceModModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("ore_black_sand");
		}
