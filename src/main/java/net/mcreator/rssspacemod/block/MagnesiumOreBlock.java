...
import net.mcreator.rssspacemod.procedures.MagnesOreIgnitionProcedure;
...
public class MagnesiumOreBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:magnesium_ore")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("rss_space_mod:magnesium_ore_match"),
