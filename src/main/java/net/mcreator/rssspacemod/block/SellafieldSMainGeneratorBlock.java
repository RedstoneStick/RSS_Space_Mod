...
import net.mcreator.rssspacemod.procedures.SellafieldSMainGeneratorUpdateTickProcedure;
...
public class SellafieldSMainGeneratorBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:sellafield_s_main_generator")
	public static final Block block = null;

	public SellafieldSMainGeneratorBlock(RssSpaceModModElements instance) {
		super(instance, 105);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sellafield_s_main_generator");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			SellafieldSMainGeneratorUpdateTickProcedure.executeProcedure(Stream
