...
public class OreBlackSandTitaniumBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:ore_black_sand_titanium")
	public static final Block block = null;

	public OreBlackSandTitaniumBlock(RssSpaceModModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("ore_black_sand_titanium");
		}
