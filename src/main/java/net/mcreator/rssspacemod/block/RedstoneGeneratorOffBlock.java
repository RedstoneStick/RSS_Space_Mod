...
import net.mcreator.rssspacemod.procedures.RedstoneGeneratorOffRedstoneOnProcedure;
...
public class RedstoneGeneratorOffBlock extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:redstone_generator_off")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redstone_generator_off");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RedstoneGeneratorOnBlock.block));
		}
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				RedstoneGeneratorOffRedstoneOnProcedure.executeProcedure(Stream
