...
import net.mcreator.rssspacemod.block.OreBlackSandTitaniumBlock;
...
public class PlacerDepositTopBlockAddedProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				RssSpaceModMod.LOGGER.warn("Failed to load dependency world for procedure PlacerDepositTopBlockAdded!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				RssSpaceModMod.LOGGER.warn("Failed to load dependency x for procedure PlacerDepositTopBlockAdded!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				RssSpaceModMod.LOGGER.warn("Failed to load dependency y for procedure PlacerDepositTopBlockAdded!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				RssSpaceModMod.LOGGER.warn("Failed to load dependency z for procedure PlacerDepositTopBlockAdded!");
			return;
		}
		...
		if (true == world.getWorldInfo().getGameRulesInstance().getBoolean(RSSSMStructureGenerateGameRule.gamerule)) {
			...
			if (0.05 >= new Object() {
				...
				world.setBlockState(new BlockPos((int) x, (int) y, (int) z), OreBlackSandTitaniumBlock.block.getDefaultState(), 3);
			} else if (0.35 >= new Object() {
				public double getValue(IWorld world, BlockPos pos, String tag) {
					TileEntity tileEntity = world.getTileEntity(pos);
					if (tileEntity != null)
						return tileEntity.getTileData().getDouble(tag);
