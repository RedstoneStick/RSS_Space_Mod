...
public class MagnesOreIgnitionProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				RssSpaceModMod.LOGGER.warn("Failed to load dependency world for procedure MagnesOreIgnition!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				RssSpaceModMod.LOGGER.warn("Failed to load dependency x for procedure MagnesOreIgnition!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				RssSpaceModMod.LOGGER.warn("Failed to load dependency y for procedure MagnesOreIgnition!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				RssSpaceModMod.LOGGER.warn("Failed to load dependency z for procedure MagnesOreIgnition!");
			return;
		}
		...
		if (IsNeighbouringBlockOnFireProcedure
				...
				private void run() {
					...
					if (world instanceof World && !world.isRemote()) {
						((World) world).playSound(null, new BlockPos((int) x, (int) y, (int) z),
								...
								SoundCategory.BLOCKS, (float) 10, (float) 5);
					} else {
						((World) world).playSound(x, y, z,
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.fire.ambient")),
								SoundCategory.BLOCKS, (float) 10, (float) 5, false);
					}
					new Object() {
						private int ticks = 0;
						private float waitTicks;
					...
					if (Blocks.AIR == (world.getBlockState(new BlockPos((int) (x + 1), (int) y, (int) z))).getBlock()) {
						world.setBlockState(new BlockPos((int) (x + 1), (int) y, (int) z), Blocks.FIRE.getDefaultState(), 3);
					}
					if (Blocks.AIR == (world.getBlockState(new BlockPos((int) (x + 1), (int) y, (int) (z + 1)))).getBlock()) {
					...
					if (Blocks.AIR == (world.getBlockState(new BlockPos((int) (x + 1), (int) (y + 1), (int) z))).getBlock()) {
						world.setBlockState(new BlockPos((int) (x + 1), (int) (y + 1), (int) z), Blocks.FIRE.getDefaultState(), 3);
					}
					if (Blocks.AIR == (world.getBlockState(new BlockPos((int) (x + 1), (int) (y + 1), (int) (z + 1)))).getBlock()) {
						world.setBlockState(new BlockPos((int) (x + 1), (int) (y + 1), (int) (z + 1)), Blocks.FIRE.getDefaultState(), 3);
					}
					if (Blocks.AIR == (world.getBlockState(new BlockPos((int) (x + 1), (int) (y + 1), (int) (z - 1)))).getBlock()) {
						world.setBlockState(new BlockPos((int) (x + 1), (int) (y + 1), (int) (z - 1)), Blocks.FIRE.getDefaultState(), 3);
					}
					...
					if (Blocks.AIR == (world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) (z + 1)))).getBlock()) {
						world.setBlockState(new BlockPos((int) x, (int) (y + 1), (int) (z + 1)), Blocks.FIRE.getDefaultState(), 3);
					}
					if (Blocks.AIR == (world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) (z - 1)))).getBlock()) {
						world.setBlockState(new BlockPos((int) x, (int) (y + 1), (int) (z - 1)), Blocks.FIRE.getDefaultState(), 3);
					}
					if (Blocks.AIR == (world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z))).getBlock()) {
