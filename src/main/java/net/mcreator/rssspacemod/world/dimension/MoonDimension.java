...
package net.mcreator.rssspacemod.world.dimension;
...
public class MoonDimension extends RssSpaceModModElements.ModElement {
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("rss_space_mod:moon_cracks")).getGenerationSettings()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("rss_space_mod:moon"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
