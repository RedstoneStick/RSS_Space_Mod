...
public class UraniumCrushedItem extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:uranium_crushed")
	public static final Item block = null;

	public UraniumCrushedItem(RssSpaceModModElements instance) {
		super(instance, 31);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("uranium_crushed");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7e0,5RAD/s"));
		}
	}
}
