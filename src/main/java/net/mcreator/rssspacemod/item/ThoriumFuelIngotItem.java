...
public class ThoriumFuelIngotItem extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:thorium_fuel_ingot")
	public static final Item block = null;

	public ThoriumFuelIngotItem(RssSpaceModModElements instance) {
		super(instance, 71);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("thorium_fuel_ingot");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7e0,9RAD/s"));
		}
	}
}
