...
public class UraniumFuelNuggetItem extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:uranium_fuel_nugget")
	public static final Item block = null;

	public UraniumFuelNuggetItem(RssSpaceModModElements instance) {
		super(instance, 38);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("uranium_fuel_nugget");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7e0,225RAD/s"));
		}
	}
}
