...
public class UraniumIngotItem extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:uranium_ingot")
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7e0,35RAD/s"));
		}
	}
}
