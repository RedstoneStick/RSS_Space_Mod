...
public class EngineBlueprintItem extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:engine_blueprint")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("engine_blueprint");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Incomplete"));
		}
