...
public class Uranium238NuggetItem extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:uranium_238_nugget")
	public static final Item block = null;

	public Uranium238NuggetItem(RssSpaceModModElements instance) {
		super(instance, 64);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("uranium_238_nugget");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7e0,025RAD/s"));
		}
	}
}
