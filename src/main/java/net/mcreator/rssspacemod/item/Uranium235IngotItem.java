...
public class Uranium235IngotItem extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:uranium_235_ingot")
	public static final Item block = null;

	public Uranium235IngotItem(RssSpaceModModElements instance) {
		super(instance, 35);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("uranium_235_ingot");
		}
