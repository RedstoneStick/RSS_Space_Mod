...
public class Uranium238IngotItem extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:uranium_238_ingot")
	public static final Item block = null;

	public Uranium238IngotItem(RssSpaceModModElements instance) {
		super(instance, 33);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("uranium_238_ingot");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7e0,25RAD/s"));
		}
	}
}
