...
public class Uranium235NuggetItem extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:uranium_235_nugget")
	public static final Item block = null;

	public Uranium235NuggetItem(RssSpaceModModElements instance) {
		super(instance, 66);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("uranium_235_nugget");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7e0,1RAD/s"));
		}
	}
}
