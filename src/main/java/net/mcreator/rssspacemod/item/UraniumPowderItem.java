...
public class UraniumPowderItem extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:uranium_powder")
	public static final Item block = null;

	public UraniumPowderItem(RssSpaceModModElements instance) {
		super(instance, 32);
	}
