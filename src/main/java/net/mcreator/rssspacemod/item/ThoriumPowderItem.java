...
public class ThoriumPowderItem extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:thorium_powder")
	public static final Item block = null;

	public ThoriumPowderItem(RssSpaceModModElements instance) {
		super(instance, 42);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("thorium_powder");
		}
