...
public class UraniumNuggetItem extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:uranium_nugget")
	public static final Item block = null;

	public UraniumNuggetItem(RssSpaceModModElements instance) {
		super(instance, 30);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7e0,035RAD/s"));
		}
	}
}
