...
public class ThoriumFuelNuggetItem extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:thorium_fuel_nugget")
	public static final Item block = null;

	public ThoriumFuelNuggetItem(RssSpaceModModElements instance) {
		super(instance, 44);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("thorium_fuel_nugget");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7e0,09RAD/s"));
		}
	}
}
