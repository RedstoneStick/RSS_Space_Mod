...
public class ThoriumCrushedItem extends RssSpaceModModElements.ModElement {
	@ObjectHolder("rss_space_mod:thorium_crushed")
	public static final Item block = null;

	public ThoriumCrushedItem(RssSpaceModModElements instance) {
		super(instance, 41);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("thorium_crushed");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7e0,15RAD/s"));
		}
	}
}
