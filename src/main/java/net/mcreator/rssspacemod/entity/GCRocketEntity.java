...
import net.mcreator.rssspacemod.entity.renderer.GCRocketRenderer;
...
public class GCRocketEntity extends RssSpaceModModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(DevToolsCreativeTabItemGroup.tab))
				.setRegistryName("gc_rocket_spawn_egg"));
	}
