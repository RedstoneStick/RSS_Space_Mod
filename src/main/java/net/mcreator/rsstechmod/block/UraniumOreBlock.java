...
public class UraniumOreBlock extends RssTechModModElements.ModElement {
	@ObjectHolder("rss_tech_mod:uranium_ore")
	public static final Block block = null;

	public UraniumOreBlock(RssTechModModElements instance) {
		super(instance, 4);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("rss_tech_mod:uranium_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("rss_tech_mod:uranium_ore"), configuredFeature);
		}
	}
