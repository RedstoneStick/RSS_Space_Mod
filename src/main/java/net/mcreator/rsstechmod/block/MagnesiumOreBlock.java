...
import net.mcreator.rsstechmod.procedures.MagnesOreIgnitionProcedure;
...
public class MagnesiumOreBlock extends RssTechModModElements.ModElement {
	@ObjectHolder("rss_tech_mod:magnesium_ore")
	public static final Block block = null;

	public MagnesiumOreBlock(RssTechModModElements instance) {
		super(instance, 7);
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			MagnesOreIgnitionProcedure.executeProcedure(Stream
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("rss_tech_mod:magnesium_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("rss_tech_mod:magnesium_ore"), configuredFeature);
		}
	}
