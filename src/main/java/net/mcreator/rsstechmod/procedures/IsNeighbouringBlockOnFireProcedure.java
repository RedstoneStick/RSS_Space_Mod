	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				RssTechModMod.LOGGER.warn("Failed to load dependency world for procedure IsNeighbouringBlockOnFire!");
			return false;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				RssTechModMod.LOGGER.warn("Failed to load dependency x for procedure IsNeighbouringBlockOnFire!");
			return false;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				RssTechModMod.LOGGER.warn("Failed to load dependency y for procedure IsNeighbouringBlockOnFire!");
			return false;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				RssTechModMod.LOGGER.warn("Failed to load dependency z for procedure IsNeighbouringBlockOnFire!");
			return false;
		}
