...
package net.mcreator.rsstechmod.world.dimension;
...
public class MoonDimension extends RssTechModModElements.ModElement {
	public MoonDimension(RssTechModModElements instance) {
		super(instance, 2);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("rss_tech_mod:moon_cracks")).getGenerationSettings()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("rss_tech_mod:moon"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
