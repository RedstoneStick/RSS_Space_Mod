...
public class MoonCracksBiome extends RssTechModModElements.ModElement {
	public static Biome biome;

	public MoonCracksBiome(RssTechModModElements instance) {
		super(instance, 1);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("rss_tech_mod:moon_cracks"));
			}
		}
	}
