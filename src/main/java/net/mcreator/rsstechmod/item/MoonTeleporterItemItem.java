...
public class MoonTeleporterItemItem extends RssTechModModElements.ModElement {
	@ObjectHolder("rss_tech_mod:moon_teleporter_item")
	public static final Item block = null;

	public MoonTeleporterItemItem(RssTechModModElements instance) {
		super(instance, 3);
	}
