...
package net.mcreator.rsstechmod.item;
...
public class ArmorAstronautSuitItem extends RssTechModModElements.ModElement {
	@ObjectHolder("rss_tech_mod:armor_astronaut_suit_helmet")
	public static final Item helmet = null;
	@ObjectHolder("rss_tech_mod:armor_astronaut_suit_chestplate")
	public static final Item body = null;
	@ObjectHolder("rss_tech_mod:armor_astronaut_suit_leggings")
	public static final Item legs = null;
	@ObjectHolder("rss_tech_mod:armor_astronaut_suit_boots")
	public static final Item boots = null;

	public ArmorAstronautSuitItem(RssTechModModElements instance) {
		super(instance, 11);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD,
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "rss_tech_mod:textures/astronaut_suit_texture.png";
			}
